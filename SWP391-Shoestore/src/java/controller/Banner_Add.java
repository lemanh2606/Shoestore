...
@MultipartConfig(location="/mkt/addbanner",fileSizeThreshold=1024*1024, maxFileSize=1024*1024*10, maxRequestSize=1024*1024*5*5) // location="/mkt/addbanner"
public class Banner_Add extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String imgpath= ""; // String imgpath= "resources\\img\\banner\\";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        Banner banner = new Banner();
        String imgpath= "resources\\img\\banner\\"; // String imgpath= "resources\\img\\banner\\";
