                    ...
                    <form action="register" method="post" name="signup" id="RegForm">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="password" class="form-control" placeholder="Password"
                                   required name="pass" id="password">
                        </div>
                        <div class="form-group mb-4">
                            <label class="label">Re-Password</label>
                            <input type="password" class="form-control" placeholder="Re-password"
                                   required name="repass" id="repassword">
                        </div>
                        ...
                        <div class="form-group mb-3 text-center">
                            <button type="submit" class="col-lg-5 btn btn-primary btn-lg button-border" id="submitBtn" name="action" value="Register">SIGN UP</button>
                        </div>
                    </form>
                    <p class="text-center" style="font-size: 15px;">Already have an account? <a data-toggle="tab"
                                                                                                href="signin.jsp">Back to Sign
                            In</a></p>
                </div>
            </div>
        </div>
