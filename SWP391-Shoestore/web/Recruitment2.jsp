...
<html>
    ...
    <body>
        ...
        <div class="form">
            ...
            <div class="post-time">
                <i class="fa fa-calendar"></i> Ngày:  23-03-2024
            </div>
