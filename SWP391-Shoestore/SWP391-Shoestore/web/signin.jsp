            ...
            <div class="login-wrap p-4 p-md-5 col-lg-4">
                <div class="col-lg-10 mx-auto">
                    ...
                    <div style="margin: 20px auto; width: fit-content; text-align: center;">
                        <a href="https://accounts.google.com/o/oauth2/auth?scope=profile&redirect_uri=http://localhost:9999/demo4/LoginGoogleHandler&response_type=code&client_id=682157088342-pneskdoadv76c8kh40mbs2enfm1bqcpn.apps.googleusercontent.com&approval_prompt=force"
